...
export default function Home() {
  ...
  return (
    <div className="pattern-back min-h-screen">
      <main className="p-12 pt-36 md:pt-12 bg-[url('/bg.svg')] bg-cover bg-center flex flex-col gap-0 row-start-2 items-center justify-start text-center sm:items-start min-h-[75vh]">
        <h1 className="w-full text-[4.5rem] md:text-[10rem] mb-0 font-semibold text-color-900 --font-summer-loving-sans" style={{ lineHeight: 1 }}>
          curingwithCARE
        </h1>
        <p className="w-full mt-12 text-3xl"><i>Dedicated to the advancement of <br></br>
        cancer <span className="underline">awareness</span>, <span className="underline">research</span>, and <span className="underline">education</span></i></p>
      ...
      <section className="text-center flex gap-8 justify-center items-center min-h-[100vh] mt-24 pt-8 relative">
          <h1 className="--font-summer-loving-sans col-span-3 font-bold text-[7rem] leading-none text-color-300 md:text-color-800 bg-[rgba(0,0,0,0.6)] md:bg-[transparent] pb-8 mb-8 z-10 w-[fit-content] p-4 rounded-xl">Our Events
          ...
          <div className="absolute inset-0 z-0 grid grid-cols-2 md:grid-cols-3 gap-0 opacity-75 left-0 right-0">
            {files.map((file, index) => (
              <div key={index} className={`hexagon ${index == 4 ? 'hidden' : ''} md:inline-grid`}>
      ...
      <section className="p-12 text-center grid grid-cols-1 sm:grid-cols-3 gap-8 justify-center min-h-[60vh] pt-8 mt-24" style={{ placeItems: "center" }}>
        ...
        <div className="col-span-3 md:col-span-1 text-center flex flex-col items-center justify-center gap-4 bg-[url('/blob3.svg')] w-[80vw] md:w-[22vw] md:h-[22vw] h-[80vw] bg-no-repeat bg-center pb-8">
        ...
        <div className="col-span-3 md:col-span-1 text-center flex flex-col items-center justify-center gap-4 bg-[url('/blob2.svg')] w-[80vw] md:w-[22vw] md:h-[22vw] h-[80vw]  bg-no-repeat bg-center pb-8">
        ...
        <div className="col-span-3 md:col-span-1 text-center flex flex-col items-center justify-center gap-4 bg-[url('/blob.svg')] w-[80vw] md:w-[22vw] md:h-[22vw] h-[80vw]  bg-no-repeat bg-center pb-8">
      ...
      <section className="p-12 text-center gap-8 justify-center min-h-[40vh] pt-8 mt-12" style={{ placeItems: "center" }}>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <a href="/" className="relative inline-block text-lg group">
              ...
              >
                  ...
                  <span className="relative flex items-center gap-2 text-[#dd2a7b] hover:text-white"><FontAwesomeIcon size="lg" icon={faInstagram} /> @curingwithcare</span>
              </span>
          ...
          <a href="/" className="relative inline-block text-lg group">
              ...
              >
                  ...
                  <span className="relative flex items-center gap-2 text-[#0a66c2] hover:text-white"><FontAwesomeIcon size="lg" icon={faLinkedin} /> curingwithCARE</span>
              </span>
          ...
          <a href="/" className="relative inline-block text-lg group">
              ...
              >
                  ...
                  <span className="relative flex items-center gap-2 text-[#0861f2] hover:text-white"><FontAwesomeIcon size="lg" icon={faFacebook} /> curingwithcare</span>
              </span>
